...
class CanonicalizerTest extends TestCase
{
    ...
    {
        $this->assertIsString(
            $this->getCanonicalizer(255)
                ->canonicalize('Some fancy text with 2 numbers or whatever...')
        );
    }
    ...
    public function testCanonicalize(): void
    {
        ...
        $this->assertEquals(
            ...
            $this->getCanonicalizer(255)
                ->canonicalize('A quick brown fox jumps over the lazy dog')
        );
        $this->assertContains(
            $this->getCanonicalizer(255)
                ->canonicalize(
        ...
        $this->assertEquals(
            ...
            $this->getCanonicalizer(255)
                ->canonicalize('Quel fez sghembo copre davanti')
        );
        $this->assertEquals(
            'pchnac-w-te-lodz-jeza-lub-osm-skrzyn-fig',
            $this->getCanonicalizer(255)
                ->canonicalize('Pchnąć w tę łódź jeża lub ośm skrzyń fig')
        );
        $this->assertEquals(
    ...
    public function testEnding(): void
    {
        ...
        $this->assertEquals(
            ...
            $this->getCanonicalizer(80)
                ->canonicalize('A quick brown fox jumps over the lazy dog', '-ending')
        );
        $this->assertContains(
            $this->getCanonicalizer(80)
                ->canonicalize(
        ...
        $this->assertEquals(
            ...
            $this->getCanonicalizer(80)
                ->canonicalize('Quel fez sghembo copre davanti', '-ending')
        );
        $this->assertEquals(
            'pchnac-w-te-lodz-jeza-lub-osm-skrzyn-fig-ending',
            $this->getCanonicalizer(80)
                ->canonicalize('Pchnąć w tę łódź jeża lub ośm skrzyń fig', '-ending')
        );
        $this->assertEquals(
